...
open class SwiftyWaveView: UIView {
    ...
    fileprivate let waves = [Wave(att: 1, lineWidth: 3, opacity: 1.0),
                             Wave(att: 2, lineWidth: 2, opacity: 0.6),
                             Wave(att: 4, lineWidth: 2, opacity: 0.4),
                             Wave(att: -6, lineWidth: 2, opacity: 0.2),
                             Wave(att: -2, lineWidth: 2, opacity: 0.1)
                            ]
